...
#define portTIMER_FOSC_SCALE			( ( unsigned portLONG ) 64 )
#define portTIMER_RELOAD				( 65536L - ( configCPU_CLOCK_HZ / portTIMER_FOSC_SCALE ) / configTICK_RATE_HZ )
...
#define portGLOBAL_INTERRUPT_FLAG			0xC0
...
#define portCOMPILER_MANAGED_MEMORY_SIZE	( ( unsigned portCHAR ) 0x33 )
...
{																				\
	...
	_asm																		\
		...
		CLRF	FSR0L, 0														\
		CLRF	FSR0H, 0														\
		MOVFF	POSTINC0, PREINC1 /*01*/ 										\
		MOVFF	POSTINC0, PREINC1 /*02*/										\
		MOVFF	POSTINC0, PREINC1 /*03*/										\
		MOVFF	POSTINC0, PREINC1 /*04*/     								    \
		MOVFF	POSTINC0, PREINC1 /*05*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*06*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*07*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*08*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*09*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*0A*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*0B*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*0C*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*0D*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*0E*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*0F*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*10*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*11*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*12*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*13*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*14*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*15*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*16*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*17*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*18*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*19*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*1A*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*1B*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*1C*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*1D*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*1E*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*1F*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*20*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*21*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*22*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*23*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*24*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*25*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*26*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*27*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*28*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*29*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*2A*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*2B*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*2C*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*2D*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*2E*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*2F*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*30*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*31*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*32*/    								    \												\
		MOVFF	POSTINC0, PREINC1 /*33*/    								    \												\
		MOVFF	INDF0, PREINC1													\
		MOVFF	FSR0L, PREINC1													\
		MOVFF	FSR0H, PREINC1													\
...
{																				\
	...
	_asm																		\
		...
		MOVFF	POSTDEC1, FSR0L													\
		MOVFF	POSTDEC1, POSTDEC0 /*01*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*02*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*03*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*04*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*05*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*06*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*07*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*08*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*09*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*0A*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*0B*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*0C*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*0D*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*0E*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*0F*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*10*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*11*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*12*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*13*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*14*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*15*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*16*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*17*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*18*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*19*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*1A*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*1B*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*1C*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*1D*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*1E*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*1F*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*20*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*21*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*22*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*23*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*24*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*25*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*26*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*27*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*28*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*29*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*2A*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*2B*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*2C*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*2D*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*2E*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*2F*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*30*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*31*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*32*/										\
		MOVFF	POSTDEC1, POSTDEC0 /*33*/										\
...
// Interrupt priority is compatibility mode. Vector is 8.
...
static void prvTickISR( void )
{
	...
	//PIR1bits.CCP1IF = 0;
	INTCONbits.T0IF = 0;
	WriteTimer0( (unsigned int)portTIMER_RELOAD + ReadTimer0( ) );
...
static void prvSetupTimerInterrupt( void )
{
	...
	WriteTimer0( (unsigned int)portTIMER_RELOAD );
...
#elif defined(__18F2620) || defined(__18F8722) 
    unsigned int pll_startup_counter = 600;
	OSCCON =0x70;
    OSCTUNEbits.PLLEN = 1;  //Enable the PLL and wait 2+ms until the PLL locks before enabling USB module
    while(pll_startup_counter--);
