...
signed portBASE_TYPE xUARTIOPutChar( xComPortHandle pxPort, unsigned portCHAR cOutChar, portTickType xBlockTime );
...
#define comBUFFER_LEN				( ( unsigned portBASE_TYPE ) 36 )
