...
tskTCB * pxNewTCB;
	...
	if( pxNewTCB != NULL )
	{
		...
		pxNewTCB->pxTopOfStack = (volatile portSTACK_TYPE *)pxPortInitialiseStack( pxTopOfStack, pvTaskCode, pvParameters );
...
portBASE_TYPE xReturn;
	...
	xReturn = xTaskCreate( prvIdleTask, ( signed portCHAR * ) "I", tskIDLE_STACK_SIZE, ( void * ) NULL, tskIDLE_PRIORITY, &idle_task );
